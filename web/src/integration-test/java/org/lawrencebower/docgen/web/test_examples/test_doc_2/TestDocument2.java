package org.lawrencebower.docgen.web.test_examples.test_doc_2;
...
public class TestDocument2 {
    ...
    public static final String TEST_DOC_2_NAME = "test_doc_2";

    private TestDocument2() {//force spring creation
    }
    ...
    private void prepareComponents() {
        ...
        documentViewBuilder.setCopyNumber(1);

        documentViewBuilder.setCustomerAttributeFilters("UK");

    }

    private void initDocumentBuilders() {
        documentBuilder.createDocument(TEST_DOC_2_NAME, fcc740Resource);
